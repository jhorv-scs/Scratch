module Scratch.UnitTests.ContainerTests
//open Scratch.Core.IoC
//open Xunit
//
//   
//    [<AbstractClass>]
...
//
//    let [<Fact>] ``resolving type with value type dependency in constructor should throw`` () =
...
//
//    let [<Fact>] ``resolving type with reference type dependency in constructor should inject reference`` () =
//        let container = Container()
...
//
//    let [<Fact>] ``resolving type with self type dependency in constructor should fail`` () =
//        let container = Container()
...
//
//    let [<Fact>] ``resolving type with cyclic type dependency in constructor should fail`` () =
//        let container = Container()
...
//
//    let [<Fact>] ``resolving type with fun type argument in constructor should inject factory`` () =
//        let container = Container()
